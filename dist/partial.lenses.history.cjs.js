...
var setRec = /*#__PURE__*/(process.env.NODE_ENV === 'production' ? I.id : function (fn) {
...
var clrLhsRec = /*#__PURE__*/(process.env.NODE_ENV === 'production' ? I.id : function (fn) {
...
var clrRhsRec = /*#__PURE__*/(process.env.NODE_ENV === 'production' ? I.id : function (fn) {
